...
#### <span style="background-color: skyblue">방법1. 각 Model Instance 의 save 함수를 통해 저장</span>
...
#### <span style="background-color: skyblue">방법2. 각 Model Manager의 create 함수를 통해 저장</span>
...
#### <span style="background-color: skyblue">방법2. QuerySet의 update 함수에 업데이트할 속성값을 지정하여 일괄 수정</span>
...
#### <span style="background-color: skyblue">방법1. 각 Model Instance의 delete 함수를 호출하여 삭제</span>
...
#### <span style="background-color: skyblue">방법2. QuerySet의 delete 함수를 호출하여, 관련 데이터를 삭제</span>
